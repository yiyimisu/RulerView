...
import com.scorpioneal.rulerview.R;
import com.scorpioneal.rulerview.Utils;
...
public class RulerView extends View {
     ...
     * 设置的初始值
     */
    private int mOriginValue;           // 小数点往前的数
    private int mOriginValueSmall;      // 小数点往后的数
    /**
     * 当前值
     */
    ...
    private void initValue() {
        mIndicatorHalfWidth = Utils.convertDpToPixel(mContext, 10);
        ...
        mLineTopMargin = Utils.convertDpToPixel(mContext, 12f);
        mHighLineHeight = Utils.convertDpToPixel(mContext, 18.3f);
        mShortLineHeight = Utils.convertDpToPixel(mContext, 10.3f);
    ...
    private void drawLinePartition(Canvas canvas) {
        ...
        if (null != listener) {
            int firstValue = mCurrentValue;
            int secondValue = Math.abs((int) (mOffset / (mPartitionWidth / mSmallPartitionCount)));
//            int firstValue = mCurrentValue -1;
//            int secondValue = 10 - ((int) (mOffset / (mPartitionWidth / mSmallPartitionCount)));
//            if (secondValue >= 10) {
//                firstValue += 1;
//                secondValue -= 10;
//            }
            listener.onValueChange(firstValue, secondValue);
        }
